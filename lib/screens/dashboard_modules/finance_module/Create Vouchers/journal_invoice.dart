...
class JournalInvoice extends StatefulWidget {
  const JournalInvoice({super.key});

  @override
  State<JournalInvoice> createState() => _JournalInvoiceState();
}

class _JournalInvoiceState extends State<JournalInvoice> {
  ...
  Future<void> sendPostRequest(PostDataModel postData) async {
    var url = Uri.parse('${ApiService.baseUrl}JournalVoucher/PostOrder');
    ...
    if (response.statusCode == 200) {
      ...
      setState(() {
        voucherNumberController.text = responseData.serialno.toString();
  ...
  //   var url = Uri.parse(
  //       'https://erm.scarletsystems.com:1235/Api/FinancialVoucher/GetListDtl?srno=$srno');
