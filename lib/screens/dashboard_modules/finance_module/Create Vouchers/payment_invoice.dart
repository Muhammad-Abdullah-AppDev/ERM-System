...
import 'package:scarlet_erm/models/bank_account_number_model.dart';
import 'package:scarlet_erm/models/cash_account_number_model.dart';
import 'package:scarlet_erm/models/dialog_post_data_model.dart';
import 'package:scarlet_erm/models/get_account_no_dialog.dart';
import 'package:scarlet_erm/models/list_details_model.dart';
import 'package:scarlet_erm/models/post_data_model.dart';
import 'package:scarlet_erm/models/response_data_model.dart';
...
class _PaymentInvoiceState extends State<PaymentInvoice> {
  ...
  Future<void> sendPostRequest(PostDataModel postData) async {
    var url = Uri.parse('${ApiService.baseUrl}PaymentVoucher/PostOrder');
  ...
  Future<void> submitData() async {
    ...
    if (selectedValueOne == null ||
      ...
      String formattedDateCheque = selectedDateCheque != null
          ? DateFormat('dd-MMM-yyyy').format(selectedDateCheque!).toUpperCase()
          : DateFormat('dd-MMM-yyyy').format(DateTime.now()).toUpperCase();
      ...
      PostDataModel postData = PostDataModel(
        ...
        chqNO: chequeNumberController.text,
                  ...
                  children: [
                    ElevatedButton(
                        ...
                        onPressed: () async {
                          ...
                          dataController.fetchPaymentListDetails(
