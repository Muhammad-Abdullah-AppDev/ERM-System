...
class _BankBalanceState extends State<BankBalance> {
  ...
  List<BankBalanceModel>? bankBalanceList;
  List<BankBalanceModel>? filteredList;
  ...
  Future<void> getBankBalanceData() async {
    ...
    bankBalanceList = await ApiService.getBankBalance(
        'Balances/BankBalance');
    filteredList = List<BankBalanceModel>.from(bankBalanceList!);
    _totalBalance = bankBalanceList!
            ...
            Expanded(
              child: ListView.separated(
                ...
                itemBuilder: (context, index) {
                  ...
                  BankBalanceModel selectedCustomer =
                  filteredList![index];
                  return Card(
                    child: ListTile(
