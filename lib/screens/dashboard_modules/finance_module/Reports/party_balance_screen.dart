...
class PartyBalance extends StatefulWidget {
  @override
  _PartyBalanceState createState() => _PartyBalanceState();
}
...
class _PartyBalanceState extends State<PartyBalance> {
  ...
  List<PartyBalanceModel>? customerBalanceList;
  ...
  Future<void> getBankBalanceData() async {
    ...
    customerBalanceList = await ApiService.getPartyBalance(
        'Balances/PartyBalance');
    filteredList = List<PartyBalanceModel>.from(customerBalanceList!);
