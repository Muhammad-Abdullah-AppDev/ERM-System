...
class ReceiptInvoiceUpdate extends StatefulWidget {
  var srno;
  var status;
  var vcType;
  var remarks;
  ...
  @override
  State<ReceiptInvoiceUpdate> createState() => _ReceiptInvoiceUpdateState();
}

class _ReceiptInvoiceUpdateState extends State<ReceiptInvoiceUpdate> {
  ...
  Future<void> sendUpdateRequest(UpdateVoucherDataModel updateData) async {
    ...
    var url = Uri.parse(
        '${ApiService.baseUrl}ReceiptVoucher/UpdateRcvMast');
  ...
  void initState() {
    ...
    widget.vcType == 'BRV'
        ? selectedValueOne = 'Bank Receipt'
        : selectedValueOne = 'Cash Receipt';
