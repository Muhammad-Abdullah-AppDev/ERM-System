...
class ReceiptInvoiceNoteUpdate extends StatefulWidget {
  var srno;
  var status;
  var customer;
  var vdt;
  ...
  @override
  State<ReceiptInvoiceNoteUpdate> createState() => _ReceiptInvoiceNoteUpdateState();
}

class _ReceiptInvoiceNoteUpdateState extends State<ReceiptInvoiceNoteUpdate> {
  final InventoryDataController dataController = Get.put(InventoryDataController());
  ...
  Future<void> sendUpdateRequest(
    ...
    try {
      var url = Uri.parse(
          '${ApiService.baseUrl}GRNGoodsReceiptNote/UpdateDGNInvoiceMast');
